        ...
        Invoke-RunspaceWithScriptBlock -ArgumentList  $choco -ScriptBlock {
            ...
            try{
                ...
                if($msg -eq "Yes")
                {
                    ...
                    # $sync['window'].FindName('list').Dispatcher.Invoke([Action]{
                    #     foreach ($item in $sync['window'].FindName('list').Items)
                    #     {
        ...
        Invoke-RunspaceWithScriptBlock -ArgumentList  $tweeaks -ScriptBlock {
            ...
            try{
                ...
                if($msg -eq "Yes")
                {
                    ...
                    #     $sync['window'].FindName('tweaks').Dispatcher.Invoke([Action]{
                    #     foreach ($item in $sync['window'].FindName('tweaks').Items)
                    #     {
                    #         $item.IsChecked = $false
                    #     }
...
#                 $sync['window'].FindName('quotes').Dispatcher.Invoke([Action]{
#                     $sync['window'].FindName('quotes').Text = "`".$name`""
#                 })
