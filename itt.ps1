...
################################################################################################################
###                                                                                                          ###
### WARNING: This file is automatically generated DO NOT modify this file                                    ###
###                                                                                                          ###
################################################################################################################
...
<TabControl x:Name="taps" TabStripPlacement="Left" Margin="0, 0, 0, 10" Grid.Row="1" BorderBrush="{x:Null}" Foreground="White" Background="#222831">
    ...
    <TabItem Header="Tweeks" x:Name="tweeks" Padding="16" BorderBrush="{x:Null}" Background="{x:Null}" Foreground="White">
        <TabItem.Content>
            <ListView Name="tweekslist" ScrollViewer.VerticalScrollBarVisibility="Auto" BorderBrush="{x:Null}" Background="#222831">
            </ListView>
        </TabItem.Content>
    </TabItem>
</TabControl>
<!--End TabControl-->
		...
		<Button Name="installBtn" Template="{StaticResource NoMouseOverButtonTemplate}" Cursor="Hand"  VerticalAlignment="Top" Content="Install" Width="100" Height="40" BorderBrush="{x:Null}"  Background="#FF204E" Foreground="White"/>
		<Button Name="applyBtn" Template="{StaticResource NoMouseOverButtonTemplate}" Cursor="Hand"   VerticalAlignment="Top" Content="Apply" Visibility="Hidden" Width="100" Height="40" BorderBrush="{x:Null}"  Background="#FF204E" Foreground="White"/>
        </Grid>

        <Grid Grid.Row="1" Grid.Column="1" Margin="15">
            <StackPanel Orientation="Vertical">
                <TextBlock FontFamily="{StaticResource FontAwesome}" Name="Discription" Text="???" TextWrapping="Wrap" Foreground="WhiteSmoke"/>
